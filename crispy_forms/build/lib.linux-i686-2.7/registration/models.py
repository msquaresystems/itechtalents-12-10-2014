...
class JSLanguage(models.Model):
    ...
    write = models.CharField(max_length=100, blank=True, null=True)
    speak = models.CharField(max_length=100, blank=True, null=True)
...
class JSResumeActive(models.Model):
    user = models.OneToOneField(User)
    JS = models.OneToOneField(JSDetails)        
    resumeActive = models.ForeignKey(JSResume, unique=True)
...
class JSDetailOther(models.Model):
    ...
    relocate=models.CharField(max_length=200, blank=True, null=True)
    telecommunicate=models.CharField(max_length=200, blank=True, null=True)
...
#class js_order_details(models.Model):
...
class Blog(models.Model):
    ...
    bimage=models.ImageField(upload_to='BlogImage', blank=True)
...
class JSsavesearch(models.Model):
    ...
    searchlink=models.CharField(max_length=500)
