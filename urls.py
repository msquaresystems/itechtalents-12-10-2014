...
urlpatterns = patterns('',
    url(r'^video-resume/v1/record/demo/', direct_to_template, {'template': 'video-resume-v1-record.html'}, name='video-resume-record'),
    url(r'^video-resume/v1/playback/demo/', direct_to_template, {'template': 'video-resume-v1-playback.html'}, name='video-resume-playback'),
...
#    urlpatterns = patterns('',
   # (r'^admin/', include('django.contrib.admin.urls')),
    ...
    url(r'^remove_profilepic_info/$', 'jsprofile.views.remove_profilepic_info'),
