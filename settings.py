...
DATABASES = {
      'default': {
          ...
          'NAME': 'userregdbnew1_new',                      # Or path to database file if using sqlite3.
...
DATABASES = {
      'default': {
          'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
          'NAME': 'userregdb2',                      # Or path to database file if using sqlite3.
          #'USER': 'root',                      # Not used with sqlite3.
          #'PASSWORD': 'Itech1@',                  # Not used with sqlite3.
...
DATABASES = {
      'default': {
          ...
          'NAME': 'userreg',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (CURRENT_DIR+'/tagging/templates', CURRENT_DIR+'/quorum/templates',
...
EMAIL_HOST_USER='muthu@capsone.com'
EMAIL_HOST_PASSWORD='Itech1'
...
GOOGLE_CONSUMER_KEY          = '745969792560-d1e9mp61digh86gt0865o8ijpdmq5dba.apps.googleusercontent.com'
GOOGLE_CONSUMER_SECRET       = 'jCUOGa1qGmHLnnRR_0r4pCvZ'
GOOGLE_OAUTH2_CLIENT_ID      = '745969792560-d1e9mp61digh86gt0865o8ijpdmq5dba.apps.googleusercontent.com'
